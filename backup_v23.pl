...
use Fcntl ':mode';
use constant VERSION => 'Backup v.23';
...
my $recipient = 'user@blah.com';		# Email Report Destination
my $returns = 'bounce@blah.com';	 	# Email Bounce Address
...
# SFTP Creds
my $sftp_host = 'repo';				# SFTP Server 
my $sftp_user = 'root';				# SFTP User
my $sftp_pass = 'xxx';				# SFTP Password
my $sftp_dir = '/root/backup';			# SFTP Upload Directory
# Retention Policy
